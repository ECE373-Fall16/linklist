...
public:
	...
	cout << endl;
	string  const returnMessage =roomArray[temp%100].getRoomName();//TODO error correction/////getroom eventually?
...
public:
	...
	cout << "Received roomID:" << '\n';
        cout << roomID  << endl;
	roomArray[roomID].playlist.addSongBack(songURI);////////////sudocode for a sec TODO	
